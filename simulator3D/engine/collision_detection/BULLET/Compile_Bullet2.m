...
if isunix
    if exist('/usr/local/include/bullet','dir')
        mex BulletMultibody.cpp -I/usr/local/include/bullet -I/usr/local/include/bullet/BulletDynamics -I/usr/local/include/bullet/BulletCollision -I/usr/local/include/bullet/LinearMath -L/usr/local/lib -lBulletCollision -lBulletDynamics -lLinearMath 
    else
